...
//  GitHubFollowers
//
//  Created by ANDREY VORONTSOV on 27.10.2020.
//
...
class GFEmptyStateView: UIView {
    ...
    private func configureMessageLabel() {
        ...
        let messageLabelYCenter = messageLabel.centerYAnchor.constraint(equalTo: self.centerYAnchor, constant: labelCenterYConstant)
        messageLabelYCenter.isActive = true
